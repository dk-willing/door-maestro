      ...
      >
        ...
        >
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-dark-text font-semibold text-lg">Complete Your Order</h3>
            <button onClick={onClose} className="text-dark-muted hover:text-dark-text bg-transparent border-none cursor-pointer">
              <HiX size={20} />
            </button>
          </div>
          ...
          <div className="bg-dark-surface rounded-lg p-4 mb-6">
            ...
            <p className="text-dark-muted text-sm">Qty: {quantity} &middot; Total: ${(product.price * quantity).toLocaleString()}</p>
          </div>
