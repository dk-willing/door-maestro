...
function ProductForm({ product, onSave, onClose }) {
  ...
  return (
    ...
    >
      <div
        className="bg-dark-card border border-dark-border rounded-2xl p-6 w-full max-w-lg max-h-[90vh] overflow-y-auto"
            ...
            <div>
              ...
              <div className="flex gap-2 flex-wrap">
                {existingImages.map((img, i) => (
                  <div
                    key={i}
                    className="relative w-16 h-16 rounded-lg overflow-hidden border border-dark-border"
                  >
                    <img
                      src={img}
                      alt=""
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-dark-border">
                  <th className="text-left text-dark-muted text-xs font-medium uppercase px-4 py-3">
                    Product
                  </th>
                  <th className="text-left text-dark-muted text-xs font-medium uppercase px-4 py-3">
                    Price
                  ...
                  <th className="text-right text-dark-muted text-xs font-medium uppercase px-4 py-3">
                    Actions
                  </th>
                </tr>
              </thead>
              <tbody>
                {products.map((p) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-3 text-dark-text text-sm">
                      {p.stock}
                    </td>
                    <td className="px-4 py-3">
                      <span
                        className={`px-2 py-1 rounded-full text-xs font-medium ${p.stock > 0 ? "bg-emerald-500/20 text-emerald-400" : "bg-red-500/20 text-red-400"}`}
                      >
