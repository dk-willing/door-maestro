            ...
            {[
              {
                icon: FaWhatsapp,
                label: "WhatsApp",
                value: "+233 (554) 391-919",
                href: "https://wa.me/233554391919",
              },
              {
                icon: FaPhone,
                label: "Phone",
                value: "+233 (554) 391-919",
                href: "tel:+233554391919",
              },
              {
                icon: FaEnvelope,
                label: "Email",
                value: "info@doormaestro.com",
                href: "mailto:doorkingsonline@gmail.com",
              },
              {
                icon: FaMapMarkerAlt,
                label: "Address",
                value: "Odorkor-Terrazo, Accra, Ghana",
              },
            ].map((c, i) => (
              <motion.div
                key={i}
                ...
                <div>
                  ...
                  {c.href ? (
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="text-dark-text no-underline hover:text-gold transition-colors font-medium"
                    >
                      {c.value}
                    </a>
                  ) : (
            ...
            <form
              onSubmit={(e) => {
                ...
                const msg = encodeURIComponent(
                  `Hi! My name is ${fd.get("name")}.\n\n${fd.get("message")}\n\nPhone: ${fd.get("phone")}`,
                );
                const link = document.createElement("a");
                link.href = `https://wa.me/233554391919?text=${msg}`;
                link.target = "_blank";
                link.rel = "noreferrer";
                link.click();
              }}
